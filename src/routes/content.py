...
def create_insta_post_img(
    ...
    line_height = bbox_A[3] - bbox_A[3]  # CORRECT
    ...
    viral_w = viral_bbox[2] - viral_bbox  # CORRECT
    draw.text(((1080 - viral_w) // 2, 8), viral_tag, font=viral_font, fill="red")

    # Draw each line of headline centered
    top = band_y0 + 24
    ...
    brand_w = brand_bbox[2] - brand_bbox  # CORRECT
    brand_h = brand_bbox - brand_bbox[3]  # CORRECT
    bx = (1080 - brand_w) // 2
    by = 1080 - brand_h - 40
